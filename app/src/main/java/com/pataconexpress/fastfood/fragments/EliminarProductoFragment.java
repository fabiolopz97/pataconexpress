 ...
 * {@link EliminarProductoFragment.OnFragmentInteractionListener} interface
...
public class EliminarProductoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Capturar los datos
        buttonEliminar = (Button) view.findViewById(R.id.buttonEliminar);
        imageButtonBuscar = (ImageButton) view.findViewById(R.id.imageButtonBuscarElim);
        buttonCancelar = (Button) view.findViewById(R.id.buttonCancelarElim);
        editTextNombre = (EditText) view.findViewById(R.id.editTextNombreElim);
        editTextDescripcion = (EditText) view.findViewById(R.id.editTextNombreElim);
        spinnerCategoria = (Spinner) view.findViewById(R.id.spinnerCategoriaElim);
        editTextPrecio = (EditText) view.findViewById(R.id.editTextPrecioElim);
